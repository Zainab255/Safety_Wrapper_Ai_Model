...
def run_pipeline(prompt: str , wrapper_type: str = "keyword"):
    ...
    # -------------------------
    # Step 21.2: Wrapper Selection
    # -------------------------
    WRAPPER_TYPE = wrapper_type  # options: "baseline", "keyword", "history", "query_budget"
    ...
    # Update history for history-based wrappers
    history.append({
        "user": prompt,
        "model": raw_output
    })
